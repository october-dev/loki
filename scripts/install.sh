...
# Configuration
REPO_URL_SSH="git@github.com:october-dev/loki.git"
REPO_URL_HTTPS="https://github.com/october-dev/loki.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/october-dev/loki/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
